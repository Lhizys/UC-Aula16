...
try:
    ...
    #     df_total_veiculos['recuperacao_veiculos'])

    # Correlação de Pearson
    correlacao = np.corrcoef(
        df_total_veiculos['recuperacao_veiculos'], df_total_veiculos['recuperacao_veiculos'])[0,1]
    
    print(f'Correlação: {correlacao}')

    #plotar gráfico
    plt.scatter(df_total_veiculos['roubo_veiculo'],
                df_total_veiculos['recuperacao_veiculos'])
